...
if (!class_exists('CBIA_Admin_Router')) {
    class CBIA_Admin_Router
    {
        ...
        public function render_page()
        {
            ...
            $logo_sidebar = plugins_url('assets/images/ai-blog-builder-pro.svg', CBIA_PRO_PLUGIN_FILE);
            ...
            if (is_callable($render)) {
                ...
                if (function_exists('cbia_log')) {
                    cbia_log(sprintf('No se pudo cargar la pesta̱a: %s', (string) $current), 'ERROR');
                }
            }
