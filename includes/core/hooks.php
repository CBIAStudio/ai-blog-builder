...
if (!function_exists('cbia_ajax_preview_article_stream')) {
    function cbia_ajax_preview_article_stream() {
        ...
        if (!$nonce_ok) {
            if (function_exists('cbia_log')) {
                cbia_log('[PREVIEW] Stream: nonce invalido.', 'ERROR');
            }
        ...
        if (!current_user_can('manage_options')) {
            if (function_exists('cbia_log')) {
                cbia_log('[PREVIEW] Stream: no autorizado.', 'ERROR');
            }
        ...
        if (!$service) {
            if (function_exists('cbia_log')) {
                cbia_log('[PREVIEW] Stream: servicio de preview no disponible.', 'ERROR');
            }
        ...
        if (is_wp_error($result)) {
            if (function_exists('cbia_log')) {
                cbia_log('[PREVIEW] Stream: error ' . $result->get_error_message(), 'ERROR');
            }
